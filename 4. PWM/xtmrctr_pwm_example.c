...
#define PWM_PERIOD              5000000    /* PWM period in (500 ms) */ // 5000000 lowest period that works, lower period means higher freq
						...
						u16 DeviceId, u16 IntrId)
{
	...
	do {
		...
		while (NoOfCycles < CYCLE_PER_DUTYCYCLE) { //how many times to run a duty cycle
		...
		//coded out auto looping for part B
		if (UP == 1){
